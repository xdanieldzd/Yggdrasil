    ...
    public class ProgressDialog
    {
        ...
        public void Show(Form parentForm, bool forceClassic = false)
        {
            if (TaskDialog.IsPlatformSupported && !forceClassic)
            {
                ...
                modernDialog.OwnerWindowHandle = parentForm.Handle;
                modernDialog.Cancelable = true;
                modernDialog.StartupLocation = TaskDialogStartupLocation.CenterOwner;
                modernDialog.StandardButtons = TaskDialogStandardButtons.Cancel;
                modernDialog.ExpansionMode = TaskDialogExpandedDetailsLocation.ExpandFooter;

                modernDialog.Icon = TaskDialogStandardIcon.Information;
                modernDialog.Caption = title;
                modernDialog.InstructionText = instructionText;
                modernDialog.Text = text;
                modernDialog.DetailsExpandedText = details;

                modernDialog.ProgressBar = new TaskDialogProgressBar() { State = TaskDialogProgressBarState.Marquee };
