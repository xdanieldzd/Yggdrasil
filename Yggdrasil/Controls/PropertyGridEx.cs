...
namespace Yggdrasil.Controls
{
	public class PropertyGridEx : PropertyGrid
	{
			...
			: base()
		{
			...
			gridView = GetType().BaseType.InvokeMember("gridView", BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance, null, this, null);
		...
		protected void PerformColumnAutoSize()
		{
			...
			GridItemCollection gridItems = (GridItemCollection)gridViewEntries.GetValue(gridView);
			...
			using (Graphics g = Graphics.FromHwnd(Handle))
			{
				...
				foreach (GridItem gridItem in gridItems)
				{
					...
					{
						curWidth = (int)g.MeasureString(gridItem.Label, Font).Width + autoSizeColumnMargin;
